...
func Observable[Obj any](db *statedb.DB, table statedb.Table[Obj]) stream.Observable[statedb.Change[Obj]] {
...
func (to *observable[Obj]) Observe(ctx context.Context, next func(statedb.Change[Obj]), complete func(error)) {
	go func() {
