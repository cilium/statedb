...
func (r *partIndex) encodeKey(key index.Key) []byte {
	if !r.unique {
...
func (r *partIndex) list(key index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partList(r.unique, r.tree, key)
}

func partList(unique bool, tree part.Ops[*object], key index.Key) (iter.Seq[*object], <-chan struct{}) {
	if unique {
...
func (r *partIndex) all() (iter.Seq2[index.Key, *object], <-chan struct{}) {
	return partAll(r.tree), r.rootWatch()
}

func partAll(tree part.Ops[*object]) iter.Seq2[index.Key, *object] {
...
func (r *partIndex) prefix(ikey index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partPrefix(r.unique, r.tree, ikey)
}
func partPrefix(unique bool, tree part.Ops[*object], key index.Key) (iter.Seq[*object], <-chan struct{}) {
	if !unique {
		key = encodeNonUniqueBytes(key)
	}
	iter, watch := tree.Prefix(key)
...
func (r *partIndex) lowerBound(ikey index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partLowerBound(r.unique, r.tree, ikey), r.rootWatch()
}

func partLowerBound(unique bool, tree part.Ops[*object], key index.Key) iter.Seq[*object] {
	if !unique {
		key = encodeNonUniqueBytes(key)
	}
	...
	return nonUniqueLowerBoundPartSeq(iter, key)
}
...
func (r *partIndexTxn) all() (iter.Seq2[index.Key, *object], <-chan struct{}) {
	return partAll(r.txn.Clone()), r.rootWatch()
}

// list implements tableIndexTxn.
func (r *partIndexTxn) list(ikey index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partList(r.index.unique, r.txn.Clone(), ikey)
}

// lowerBound implements tableIndexTxn.
func (r *partIndexTxn) lowerBound(ikey index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partLowerBound(r.index.unique, r.txn.Clone(), ikey), r.rootWatch()
}
...
func (r *partIndexTxn) get(key index.Key) (iobj *object, watch <-chan struct{}, ok bool) {
	return partGet(r.index.unique, r.txn, key)
}
...
func (r *partIndexTxn) prefix(ikey index.Key) (iter.Seq[*object], <-chan struct{}) {
	return partPrefix(r.index.unique, r.txn.Clone(), ikey)
}
